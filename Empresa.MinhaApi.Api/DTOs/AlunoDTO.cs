using Empresa.MinhaApi.Api.HATEOAS;
using System;
...
namespace Empresa.MinhaApi.Api.DTOs
{
    public class AlunoDTO : RestResource //Implementando o hateoas
    {
        //Atributos a serem expostos na api
